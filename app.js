...
var _user$project$Model$toggleFilter = F3(
	function (filterSet, name, active) {
		return A3(
			...
			name,
			function (_p0) {
				return _elm_lang$core$Maybe$Just(active);
			},
			filterSet);
	});
var _user$project$Model$toggleFilters = F2(
	function (toggleMsg, filters) {
		var _p1 = toggleMsg;
		switch (_p1.ctor) {
			case 'ToggleChannel':
				return _elm_lang$core$Native_Utils.update(
					filters,
					{
						channels: A3(_user$project$Model$toggleFilter, filters.channels, _p1._0, _p1._1)
					});
			case 'ToggleTarget':
				return _elm_lang$core$Native_Utils.update(
					filters,
					{
						targets: A3(_user$project$Model$toggleFilter, filters.targets, _p1._0, _p1._1)
					});
			case 'ToggleVersion':
				return _elm_lang$core$Native_Utils.update(
					filters,
					{
						versions: A3(_user$project$Model$toggleFilter, filters.versions, _p1._0, _p1._1)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					filters,
					{
						addons: A3(_user$project$Model$toggleFilter, filters.addons, _p1._0, _p1._1)
					});
		}
	});
var _user$project$Model$applyFilter = F3(
...
var _user$project$Model$getActiveFilters = function (filterSet) {
...
var _user$project$Model$applyVersionFilter = F2(
	function (filterSet, releases) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p2) {
				var _p3 = _p2;
				return A2(
					_elm_lang$core$List$any,
					function (major) {
						return A2(_elm_lang$core$String$startsWith, major, _p3.details.version);
					},
					_user$project$Model$getActiveFilters(filterSet));
			},
			releases);
	});
var _user$project$Model$applyAddonFilter = F2(
	function (filterSet, releases) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p4) {
...
var _user$project$Model$applyFilters = function (_p6) {
	var _p7 = _p6;
	var _p10 = _p7.filters;
	return A2(
		_user$project$Model$applyAddonFilter,
		_p10.addons,
		A2(
			_user$project$Model$applyVersionFilter,
			_p10.versions,
			A3(
				_user$project$Model$applyFilter,
				_p10.targets,
				function (_p8) {
					return function (_) {
						return _.target;
...
var _user$project$Model$extractAddonsFilterSet = function (releases) {
	return _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$map,
			function (addon) {
				return {ctor: '_Tuple2', _0: addon.id, _1: true};
			},
...
var _user$project$Model$extractFilterSet = F2(
	function (accessor, releases) {
		return _elm_lang$core$Dict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (_p11) {
...
var _user$project$Model$extractVersionFilterSet = function (releases) {
	var extractVersion = function (_p12) {
		var _p13 = _p12;
		var _p16 = _p13._0;
		var _p15 = _p13._1;
		var _p14 = A2(_elm_lang$core$String$split, '.', _p16);
		if (_p14.ctor === '::') {
			return {ctor: '_Tuple2', _0: _p14._0, _1: _p15};
		} else {
	...
	return _elm_lang$core$Dict$fromList(
		A2(
			...
			_elm_lang$core$Dict$toList(
				A2(
					_user$project$Model$extractFilterSet,
					function (_p17) {
						return function (_) {
							return _.version;
						}(
...
var _user$project$Model$extractFilters = function (releases) {
	return {
		channels: A2(
			_user$project$Model$extractFilterSet,
			function (_p18) {
		...
		targets: A2(
			...
			releases),
		versions: _user$project$Model$extractVersionFilterSet(releases),
		addons: _user$project$Model$extractAddonsFilterSet(releases)
	};
};
		...
		if (_p22.ctor === 'ReleasesFetched') {
			...
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					_p26,
					{
						filters: A2(_user$project$Model$toggleFilters, _p22._0, _p21.filters)
					}),
				{ctor: '[]'});
		}
	});
...
var _user$project$Model$SystemAddon = F2(
	function (a, b) {
		return {id: a, version: b};
	});
var _user$project$Model$decodeSystemAddon = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Model$SystemAddon,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'version', _elm_lang$core$Json_Decode$string));
var _user$project$Model$SystemAddonVersions = F3(
	function (a, b, c) {
		return {id: a, builtin: b, update: c};
	});
var _user$project$Model$ReleaseDetails = F7(
	function (a, b, c, d, e, f, g) {
		return {buildId: a, channel: b, filename: c, lang: d, target: e, url: f, version: g};
	});
var _user$project$Model$decodeReleaseDetails = A8(
	_elm_lang$core$Json_Decode$map7,
	_user$project$Model$ReleaseDetails,
	A2(_elm_lang$core$Json_Decode$field, 'buildId', _elm_lang$core$Json_Decode$string),
	...
	A2(_elm_lang$core$Json_Decode$field, 'version', _elm_lang$core$Json_Decode$string));
var _user$project$Model$Release = F5(
	function (a, b, c, d, e) {
		return {builtins: a, updates: b, details: c, id: d, last_modified: e};
	});
var _user$project$Model$decodeRelease = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Model$Release,
	A2(
...
var _user$project$Model$ToggleAddon = F2(
	function (a, b) {
		return {ctor: 'ToggleAddon', _0: a, _1: b};
	});
var _user$project$Model$ToggleVersion = F2(
	function (a, b) {
		return {ctor: 'ToggleVersion', _0: a, _1: b};
	});
var _user$project$Model$ToggleTarget = F2(
	function (a, b) {
		return {ctor: 'ToggleTarget', _0: a, _1: b};
	});
var _user$project$Model$ToggleChannel = F2(
	function (a, b) {
		return {ctor: 'ToggleChannel', _0: a, _1: b};
	});
var _user$project$Model$ToggleFilter = function (a) {
	return {ctor: 'ToggleFilter', _0: a};
};
var _user$project$Model$ReleasesFetched = function (a) {
	return {ctor: 'ReleasesFetched', _0: a};
};
var _user$project$Model$getReleaseList = A2(
	_Kinto$elm_kinto$Kinto$send,
	_user$project$Model$ReleasesFetched,
	A2(
		...
		A2(_Kinto$elm_kinto$Kinto$getList, _user$project$Model$recordResource, _user$project$Model$client)));
var _user$project$Model$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		...
		filters: {
			...
			targets: _elm_lang$core$Dict$fromList(
				{ctor: '[]'}),
			versions: _elm_lang$core$Dict$fromList(
				{ctor: '[]'}),
	...
	{
		ctor: '::',
		_0: _user$project$Model$getReleaseList,
		_1: {ctor: '[]'}
	});
...
var _user$project$View$viewFilters = function (_p3) {
	...
	var _p5 = _p4.filters;
	var eventHandler = F3(
		function (msg, name, active) {
			return _user$project$Model$ToggleFilter(
				A2(msg, name, active));
		});
	var addons = _elm_lang$core$Dict$toList(_p5.addons);
	var targets = _elm_lang$core$Dict$toList(_p5.targets);
	var versions = _elm_lang$core$List$reverse(
		_elm_lang$core$Dict$toList(_p5.versions));
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: A3(
				_user$project$View$filterSetForm,
				channels,
				'Channels',
				eventHandler(_user$project$Model$ToggleChannel)),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$View$filterSetForm,
					versions,
					'Versions',
					eventHandler(_user$project$Model$ToggleVersion)),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$View$filterSetForm,
						targets,
						'Targets',
						eventHandler(_user$project$Model$ToggleTarget)),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$View$filterSetForm,
							addons,
							'Addons',
							eventHandler(_user$project$Model$ToggleAddon)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$formatDate = function (last_modified) {
	return A2(
		_mgold$elm_date_format$Date_Format$format,
		'%Y/%m/%d %H:%k:%S',
		_elm_lang$core$Date$fromTime(
			_elm_lang$core$Basics$toFloat(last_modified)));
};
var _user$project$View$viewSystemAddonVersionsRow = function (addon) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(addon.id),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Maybe$withDefault, '', addon.builtin)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Maybe$withDefault, '', addon.update)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Lang'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(details.buildId),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(details.target),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(details.lang),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_user$project$View$formatDate(_p7.last_modified)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
